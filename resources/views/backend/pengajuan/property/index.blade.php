        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">Daftar Data Pengajuan Property</h4>
                </div>
                <div class="card-body">
...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $.ajax({
                url: '{{ route('admin.pengajuan-property') }}',
                type: 'GET',
                success: function(response) {
                    const datas = response.datas;

                    // Fungsi untuk format rupiah tanpa ,00 di belakangnya
                    ...
                    new gridjs.Grid({
                        columns: [{
                            ...
                            },
                            {
                                ...
                                formatter: (cell, row) => {
                                    return gridjs.html(`
                                        <button class="btn btn-primary btn-sm btn-edit" data-id="${row.cells[0].data}"><i class="bi bi-eye"></i></button>
            <button class="btn btn-danger btn-sm btn-delete" data-id="${row.cells[0].data}"><i class="bi bi-trash3"></i></button>
                                    `);
                                },
                                style: {
                                    width: '150px',
