            ...
            <div class="row">
                <div class="col-lg-5 order-md-1 order-2">
                    <div class="text-start">
                        <h1 class="hero-1-title text-dark">Pinjaman Jaminan Properti</h1>
                        <p class="text-muted mb-4 pb-3">Pinjaman Jaminan Properti Atau Gadai Properti adalah solusi cepat
                            pinjaman dana yang dapat diambil dengan menjaminkan Properti sebagai jaminan. </p>
                ...
                <div class="col-lg-7 order-md-2 order-1">
                    <div class="justify-content-center">
                        <img src="{{ asset('assets/images/foto-rumah.png') }}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="text-center mb-5">
                        <h5 class="text-primary">Gadai Properti</h5>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center mb-3">
                    <h5 class="text-primary">Simulasi Angsuran Properti</h5>
