            ...
            <div class="row">
                <div class="col-lg-5 order-md-1 order-2">
                    <div class="text-start">
                        <h1 class="hero-1-title text-dark">Pinjaman Jaminan BPKB Mobil</h1>
                        <p class="text-muted mb-4 pb-3">Pinjaman Jaminan BPKB Mobil Atau Gadai BPKB Mobil adalah solusi cepat
                            pinjaman dana yang dapat diambil dengan menjaminkan BPKB Mobil sebagai jaminan. </p>
                ...
                <div class="col-lg-7 order-md-2 order-1">
                    <div class="text-start">
                        <img src="{{ asset('assets/images/foto-mobil.png') }}" alt="" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="text-center mb-5">
                        <h5 class="text-primary">Gadai BPKB Mobil</h5>
                        <h3>Prosesnya hanya 1 hari kerja</h3>
                        <hr class="text-primary border-1">
                        <P class=" opacity-75">Teman Gadai menyediakan produk pinjaman gadai BPKB Mobil untuk memperoleh
                        ...
                        <P class=" opacity-75">Pembayaran cicilan bulanan pun sangat ringan. Dengan proses pengajuan yang
                            ...
                            dan ajukan pinjaman gadai BPKB Mobil sekarang juga!</P>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center mb-3">
                    <h5 class="text-primary">Simulasi Angsuran BPKB Mobil</h5>
                            ...
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                        ...
                                        <div class="accordion-body">
                                            <ol>
                                                ...
                                                <li>Status tempat tinggal rumah sendiri, pasangan, keluarga, kontrak tahunan
                                                    dan rumah dinas</li>
                                                <li>Profesi / Pekerjaan : Karyawan swasta (minimal Tetap 1 tahun / minimal
                                                    kontrak 2 tahun), PNS, dan Wiraswasta minimal 1 tahun berjalan</li>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <ol>
                                                <li>Mobil milik sendiri dilengkapi BPKB asli</li>
                                                <li>BPKB bisa atas nama sendiri, pasangan dan orang lain (melampirkan bukti
                                                    pembelian)</li>
                                                <li>BPKB bisa atas nama perusahaan dengan syarat melampirkan Surat Pelepasan
                                                    Hak (SPH)</li>
                                                <li>Usia kendaraan maksimal 15 tahun (minimal tahun kendaraan 2006 untuk
                                                    jenis sedan, jeep, dan minibus), dan maksimal 10 tahun (minimal tahun
                                                    kendaraan 2011 untuk jenis pick-up dan truck)</li>
                                                <li>STNK / Pajak : Atas nama sendiri (masih berlaku dan pajak mati maksimal
                                                    2 tahun akan dipotong pada jumlah pencairan), Atas nama orang lain
                                                    (hidup serta pajak mati akan dibalik nama)</li>
                                                <li>Plat kendaraan hitam (bukan plat merah)</li>
                                                <li>Plat kuning (khusus truck)</li>
                                                <li>Kendaraan tidak pernah dipergunakan sebagai taksi atau ambulans</li>
                                            </ol>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="f-16 " style="padding: 12px 20px;">Status
                                                                tempat tinggal kontrak melampirkan kwitansi / perjanjian
                                                                sewa
                                                            </td>
                                                            <td class="f-16 text-center" style="padding: 12px 20px;"><i
                                                                    class="bi bi-check-circle"></i></td>
                                                        ...
                                                        <tr>
                                                            <td class="f-16 " style="padding: 12px 20px;">Status
                                                                tempat tinggal rumah dinas melampirkan surat keterangan
                                                                menempati rumah</td>
                                                            <td class="f-16 text-center" style="padding: 12px 20px;"><i
                                                                    class="bi bi-check-circle"></i></td>
                                                            <td class="f-16 text-center" style="padding: 12px 20px;"><i
                                                        ...
                                                        <tr>
                                                            <td class="f-16 " style="padding: 12px 20px;">Slip asli
                                                                gaji 3 bulan terakhir (salah satu bulan saja) & ID Card
                                                                (untuk
                                                                Karyawan)</td>
                                                            <td class="f-16 text-center" style="padding: 12px 20px;"><i
                                                                    class="bi bi-check-circle"></i></td>
                                                        ...
                                                        <tr>
                                                            <td class="f-16 " style="padding: 12px 20px;">NPWP</td>
                                                            <td class="f-16 text-center" style="padding: 12px 20px;"><i
                                                                    class="bi bi-check-circle"></i></td>
                                                            <td class="f-16 text-center" style="padding: 12px 20px;"><i
                                                                    class="bi bi-check-circle"></i></td>
                                                        ...
                                                        <tr>
                                                            <td class="f-16 " style="padding: 12px 20px;">BPKB & STNK
                                                            </td>
                                                            <td class="f-16 text-center" style="padding: 12px 20px;"><i
                                                                    class="bi bi-check-circle"></i></td>
                                                            <td class="f-16 text-center" style="padding: 12px 20px;"><i
                                                        ...
                                                        <tr>
                                                            <td class="f-16 " style="padding: 12px 20px;">SIUP / TDP /
                                                                akta perusahaan / izin usaha/ izin praktik</td>
                                                            <td class="f-16 text-center" style="padding: 12px 20px;"><i
                                                                    class="bi bi-check-circle"></i></td>
                                                            <td class="f-16 text-center" style="padding: 12px 20px;"><i
                                                                    class="bi bi-check-circle"></i></td>
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="features-box d-flex">
                            <i class="bi bi-check2-all text-success me-2"></i>
                            <h5 class="f-18 fw-normal text-white">
                                Tenor Pinjaman dari 12 bulan sampai 48 bulan
                            </h5>
                        </div>
                        <div class="features-box d-flex">
                            <i class="bi bi-check2-all text-success me-2"></i>
                        ...
                        <div class="features-box d-flex">
                            <i class="bi bi-check2-all text-success me-2"></i>
                            <h5 class="f-18 fw-normal text-white">
                                Cover Seluruh Domisili Di Indonesia hingga 400 Kota/Kabupaten
                            </h5>
                        </div>
                        <div class="features-box d-flex">
                            <i class="bi bi-check2-all text-success me-2"></i>
                            <h5 class="f-18 fw-normal text-white">
                                Suku Bunga per Tahun, Mulai dari 7,0% sampai 14,4% per Tahun (Sesuai kondisi aset &
                                kelengkapan dokumen)
                            </h5>
                        </div>
                    </div>
